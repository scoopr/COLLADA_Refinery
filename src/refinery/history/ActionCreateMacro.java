...
/**
 * An <code>ActionCreateConditioner</code> is the undoable action representing a Macro creation.
 * 
 * @author Philippe David
 */
public class ActionCreateMacro extends Action {
	...
	public ActionCreateMacro(ActionHistory h, PipelineMacro macro){
		super(h);
